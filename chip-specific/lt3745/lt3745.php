...
<form name="formSrc" data-bind="with: lt3745">
<table id="mainTable" class="candy-calc" border="4">
	<tbody>
		<tr>
		...
		<tr>
			...
			<td><input class="input" data-bind="calcVar: loadVoltage" size="16"></input></td>
		...
		<tr>
			...
			<td><input class="output" data-bind="calcVar: vBuckOut" size="16" readonly="readonly"></input></td>
		...
		<tr>
			...
			<td><input class="output" data-bind="calcVar: vInMin" type="text" size="16" readonly="readonly" /></td>
		...
		<tr>
			...
			<td><input class="input" data-bind="calcVar: vInMax" type="text" size="16" /></td>
		...
		<tr>
			...
			<td><input class="input" data-bind="calcVar: iOutMax" type="text" size="16" /></td>
		...
		<tr>
			...
			<td><input class="output" data-bind="calcVar: rSense" type="text" size="16" readonly="readonly" /></td>
		...
		<tr>
			...
			<td><input class="output" data-bind="calcVar: prsense" type="text" size="16" readonly="readonly" /></td>
		...
		<tr>
			...
			<td><input class="input" data-bind="calcVar: iLedPinNom" type="text" size="16" /></td>
		...
		<tr>
			...
			<td><input class="output" data-bind="calcVar: riSet" type="text" size="16" readonly="readonly" /></td>
		...
		<tr>
			...
			<td><input class="output" data-bind="calcVar: dMin" type="text" size="16" readonly="readonly" /></td>
		...
		<tr>
			...
			<td><input class="output" data-bind="calcVar: dMax" type="text" size="16" readonly="readonly" /></td>
		...
		<tr>
			...
			<td><input class="input" data-bind="calcVar: tOnMin" type="text" size="16" /></td>
		...
		<tr>
			...
			<td><input class="input" data-bind="calcVar: tOffMin" type="text" size="16" /></td>
		...
		<tr>
			...
			<td><input class="output" data-bind="calcVar: fSwMax" type="text" size="16" readonly="readonly" /></td>
		...
		<tr>
			...
			<td><input class="input" data-bind="calcVar: fSwAct" type="text" size="16" /></td>
		...
		<tr>
			...
			<td><input class="input" data-bind="calcVar: vInRipple" type="text" size="16" /></td>
		...
		<tr>
			...
			<td><input class="output" data-bind="calcVar: cInMin" type="text" size="16" readonly="readonly" /></td>
