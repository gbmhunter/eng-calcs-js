...
<p>This calculator finds a standard resistance value(s) that will best match the resistance \(R\) you specify.</p>
<form name="src">
	...
	<tbody>
		...
		<tr>
			<td colspan="3" style="text-align: center;">
				<input type="radio">E12</input>
				<input type="radio">E24</input>
				<input type="radio">E48</input>
			</td>
		</tr>
		<tr>
			<td style="text-align: center;">\(R_{actual}\)</td>
			<td>
				<input id="tbRactual" type="text" size="16" />
			</td>
			<td>
				<input id="tbRactualUnits" type="text" size="3" />
			</td>
		</tr>
	</tbody>
</table>
